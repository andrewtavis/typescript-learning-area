...
function initialize() {
  ...
  var category = <HTMLInputElement>document.querySelector("#category");
  var searchTerm = <HTMLInputElement>document.querySelector("#searchTerm");
  var searchBtn = document.querySelector("button") as HTMLButtonElement;
  var main = document.querySelector("main") as HTMLElement;

  // keep a record of what the last category and search term entered were
  var lastCategory: string = category.value;
  ...
  // filters them by the entered search term (if one has bene entered)
